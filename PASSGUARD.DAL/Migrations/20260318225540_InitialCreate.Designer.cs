...
namespace PASSGUARD.DAL.Migrations
{
    ...
    [Migration("20260318225540_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PASSGUARD.Models.CheckIn", b =>
                {
            ...
            modelBuilder.Entity("PASSGUARD.Models.Pass", b =>
                {
                    b.Property<int>("PassId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PASSGUARD.Models.Security", b =>
                {
                    b.Property<int>("SecurityId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PASSGUARD.Models.CheckIn", b =>
                {
                    b.HasOne("PASSGUARD.Models.Pass", "Pass")
                        .WithMany()
                        .HasForeignKey("PassId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PASSGUARD.Models.Security", "Security")
                        .WithMany()
